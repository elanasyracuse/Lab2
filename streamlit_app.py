...
presentationlab4 = st.Page("presentationlab4.py", title="AI Fact-Checker + Citation Builder", icon="🤖",default=True)

nav = st.navigation({"Labs": [lab1, lab2, lab3, lab4, lab5, presentationlab4]})
nav.run()
