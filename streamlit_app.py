...
lab8 = st.Page("lab8.py", title="Lab 8 ", default=True)
lab9 = st.Page("lab9.py", title="Lab 9")  # Changed st.page to st.Page
presentationlab4 = st.Page("presentationlab4.py", title="AI Fact-Checker + Citation Builder", icon="🤖")

nav = st.navigation({"Labs": [lab1, lab2, lab3, lab4, lab5, lab8, lab9, presentationlab4]})
nav.run()